...
function createFieldAggregation({ context, nodeLabel, node, field, }) {
    ...
    const apocRunParams = { ...apoc_run_1.serializeParamsForApocRun(whereParams), ...utils_1.serializeAuthParamsForApocRun(authData) };
    return {
...
function createCountQuery({ nodeLabel, matchWherePattern, targetAlias, params, }) {
    const apocCount = apoc_run_1.wrapInApocRunFirstColumn(AggregationSubQueries.countQuery(matchWherePattern, targetAlias), {
        ...params,
        [nodeLabel]: nodeLabel,
    });
