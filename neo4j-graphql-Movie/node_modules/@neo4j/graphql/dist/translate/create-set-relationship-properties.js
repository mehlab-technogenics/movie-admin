...
*/
function createSetRelationshipProperties({ properties, varName, relationship, operation, parameterPrefix, }) {
    const strs = [];
    ...
    relationship.temporalFields.forEach((temporalField) => {
        var _a;
        if (["DateTime", "Time"].includes(temporalField.typeMeta.name) && ((_a = temporalField === null || temporalField === void 0 ? void 0 : temporalField.timestamps) === null || _a === void 0 ? void 0 : _a.includes(operation))) {
    ...
    Object.entries(properties).forEach(([key]) => {
        ...
        const dbFieldName = map_to_db_property_1.default(relationship, key);
