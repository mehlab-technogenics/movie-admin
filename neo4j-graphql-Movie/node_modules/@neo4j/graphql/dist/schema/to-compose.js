    ...
    return args.reduce((res, arg) => {
        ...
        return {
            ...
            [arg.name.value]: {
                ...
                ...(arg.defaultValue ? { defaultValue: parse_value_node_1.default(arg.defaultValue) } : {}),
            },
        };
    }, {});
}
...
function graphqlDirectivesToCompose(directives) {
    return directives.map((directive) => {
        var _a;
        return ({
            args: (_a = (directive.arguments || [])) === null || _a === void 0 ? void 0 : _a.reduce((r, d) => ({ ...r, [d.name.value]: parse_value_node_1.default(d.value) }), {}),
